...
public class Scheduler implements Runnable {
    ...
    private void instructElevator(Parser parser) throws Exception {
        ...
        String message = "status: Move" + ";floor:" + userLocation;        // need to remove later
    ...
    private void updateElevatorStatus(Parser parser) throws Exception {
        ...
        if(currentElevatorStatus.getCurrentAction() == parser.getFloor()){    // Elevator arrive the target floor
            int nextFloor = currentElevatorStatus.popNextStop();    // get next action

            String message = "status: Move" + ";floor:" + nextFloor;        // Formal the message for elevator's next action
